...
import type { DurableObjectStub } from "@cloudflare/workers-types/experimental/index";
import type { DBMSDO } from "../index";
import { migrations } from "./migrations";

const INTERNAL_CONFIG_DATABASE_ID = `workers-dbsm-internal-configs`;

export async function getConfigDatabase(
	env: Env,
): Promise<DurableObjectStub<DBMSDO>> {
